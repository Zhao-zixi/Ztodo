  ...
  return (
    <div className="h-screen flex flex-col bg-white dark:bg-zinc-950
      ...
      >
        ...
        {/* 搜索栏 */}
        <div className="flex-1 max-w-[280px] relative" data-tauri-drag-region={false as any}>
        ...
        <div className="flex items-center gap-1" data-tauri-drag-region={false as any}>
          ...
          {/* AI 助手 */}
          <button onClick={() => setRefreshKey(k => k)} /* trigger AIChat awareness */
            className="w-7 h-7 rounded-lg flex items-center justify-center
      ...
      {showLLMSettings && (
        <div className="px-4 py-3 border-b border-zinc-100 dark:border-zinc-800
                        ...
                        grid grid-cols-3 gap-3 shrink-0">
      ...
      {/* AI 助手面板 */}
      <AIChat onRefresh={handleTaskAdded} llmConfig={llmConfig} />
    </div>
  );
}
